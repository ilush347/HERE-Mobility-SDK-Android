...
### Mobility Demand<a name="mobility-demand"></a>
...
The HERE Mobility SDK version 1.0.3 supports Android version 4.0.4 (API level 15) or later.
...
dependencies{
	...
	implementation "com.here.mobility.sdk:demand:1.0.3"
	implementation "com.here.mobility.sdk:map:1.0.3"
}
```
...
### Creating an `Application` Class <a name="application-class"></a>
